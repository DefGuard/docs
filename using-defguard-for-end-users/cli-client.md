...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/e86iamwJVSYnIRsyVEAV/using-defguard-for-end-users/cli-client
---
...
Defguard CLI works only with [network devices](../features/network-devices.md), so to use it, you will need to first add a new network device. Refer to the network device documentation to learn more.
