...
To create a new rule, use the ![](<../../.gitbook/assets/image (11).png>) button in the [ACL List View](./#list-of-acl-rules).

You can edit an existing rule by using the ![](<../../.gitbook/assets/image (17).png>) context menu and selecting **"Edit"** in the [ACL List View](./#list-of-acl-rules)**.**

<figure><img src="../../.gitbook/assets/image (18).png" alt=""><figcaption><p>Rule context menu</p></figcaption></figure>
