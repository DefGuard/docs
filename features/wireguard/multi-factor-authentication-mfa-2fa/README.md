...
2. **external - using cloud IdP/SSO providers** such as [Google](../../external-openid-providers/google.md), [Microsoft](../../external-openid-providers/microsoft.md), [Okta](../../external-openid-providers/okta.md), [Jumpcloud](../../external-openid-providers/jumpcloud.md) (and others) to authorize each connection using those providers in Defguard desktop/mobile before the connection can be established - [<mark style="color:$warning;">from 1.5 version - see 1.5 docs</mark>](./)<mark style="color:$warning;">.</mark>
...
Defguard also supports **multiple VPN locations (multiple VPNs), each of which can be configured independently to use either internal or external MFA (also** [<mark style="color:$warning;">**from 1.5 version - see 1.5 docs**</mark>](./)<mark style="color:$warning;">**).**</mark>

### Multi device MFA

{% hint style="warning" %}
This is supported from[ 1.5 version. See  1.5 docs. ](./)
{% endhint %}
