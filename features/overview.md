...
If you're more interested in different deployment strategies after using our [one-line install script](../getting-started/one-line-install.md), go to the [deployment strategies](https://github.com/DefGuard/docs/blob/docs/admin-and-features/broken-reference/README.md) section.
