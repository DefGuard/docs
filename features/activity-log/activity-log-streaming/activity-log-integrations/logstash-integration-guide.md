...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/e86iamwJVSYnIRsyVEAV/features/activity-log/activity-log-streaming/activity-log-integrations/logstash-integration-guide
---
...
In Defguard UI with an administrator account, go into settings page and choose `Activity streaming` tab.
