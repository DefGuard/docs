...
Make sure you selected "Enable LDAP integration" as without it, the two-way synchronization won't work. After you fill out all the fields, test your configuration using the <img src="../../.gitbook/assets/image (3).png" alt="" data-size="line"> button.&#x20;
...
2. Temporarily disable the whole LDAP integration in the settings ![](<../../.gitbook/assets/image (182).png>)
...
4. Enable the LDAP integration in the settings <img src="../../.gitbook/assets/image (184).png" alt="" data-size="line">
