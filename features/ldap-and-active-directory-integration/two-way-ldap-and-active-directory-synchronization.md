...
2. Temporarily disable the whole LDAP integration in the settings ![](<../../.gitbook/assets/image (192).png>)
...
4. Enable the LDAP integration in the settings <img src="../../.gitbook/assets/image (194).png" alt="" data-size="line">
