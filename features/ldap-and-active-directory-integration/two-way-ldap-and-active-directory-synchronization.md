...
Make sure you selected "Enable LDAP integration" as without it, the two-way synchronization won't work. After you fill out all the fields, test your configuration using the <img src="../../.gitbook/assets/image (40).png" alt="" data-size="line"> button.
...
2. Temporarily disable the whole LDAP integration in the settings ![](<../../.gitbook/assets/image (196).png>)
...
4. Enable the LDAP integration in the settings <img src="../../.gitbook/assets/image (198).png" alt="" data-size="line">
