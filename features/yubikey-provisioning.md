...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/e86iamwJVSYnIRsyVEAV/features/yubikey-provisioning
---
...
3.  Select "Add YubiKey" from the actions menu for a User in the list.
    ...
    <figure><img src="../.gitbook/assets/image (136).png" alt="" width="301"><figcaption></figcaption></figure>
