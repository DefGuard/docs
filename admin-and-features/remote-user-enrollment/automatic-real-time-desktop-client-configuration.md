...
1. If using the **Open Source Open Core** - the administrator needs to send a new configuration token to each user affected, and the user needs to [update the instance](../../help/desktop-client/instance-configuration.md#updating-instance) in the desktop client with the new obtained token.
