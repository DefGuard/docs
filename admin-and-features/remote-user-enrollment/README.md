...
Please also see the relevant configuration options for [core](../../configuration.md#enrollment-configuration) and the [proxy itself](../../configuration.md#enrollment-service).
{% endhint %}
