...
3. The "Send email" button is active only if you [configured the SMTP server](../admin-and-features/features-and-configuration/setting-up-smtp-for-email-notifications.md).
