...
*   Make sure Defguard Gateway has been properly adopted. If not adopted, Gateway won't configure any WireGuard network interfaces. After the adoption, there should be files in `/etc/defguard/certs`.
