...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/e86iamwJVSYnIRsyVEAV/for-developers/dev-env-setup
---
...
Consult [Configuration](../../deployment-strategies/configuration.md) manual for a list of all available configuration settings.
