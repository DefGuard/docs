...
{% hint style="info" %}
If you are an administrator and want to find out how to generate tokens[ you read more here](../../../admin-and-features/features-and-configuration/wireguard/remote-desktop-activation.md).
{% endhint %}
