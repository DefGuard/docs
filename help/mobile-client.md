...
<figure><img src="../.gitbook/assets/defguard-mobile-connecting.gif" alt="" width="50%"><figcaption></figcaption></figure>
...
{% hint style="info" %}
**Before** proceeding, please read [this](mobile-client.md#how-can-i-obtain-qr-code-url-and-token)
{% endhint %}
