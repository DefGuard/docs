...
Your license also carries **usage limits** - the number of users and the number of VPN locations, and optionally device counts. The current tier, expiry date, and how close you are to each limit are shown in **Settings → License**.
