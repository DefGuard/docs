...
* Ability to [stream the Activity & Audit logs to external SIEM systems](../admin-and-features/activity-log/activity-log-streaming/)
...
* Ability to integrate with external tooling using [REST API](../admin-and-features/integrations/api-tokens.md).
